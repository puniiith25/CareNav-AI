...
class Store:
    ...
    def _seed(self) -> None:
        ...
        self.hospitals = {
            ...
            I.HOSPITAL_APOLLO: {
                "id": I.HOSPITAL_APOLLO,
                "name": "Apollo Super Specialty Care - Bannerghatta",
                "slug": "apollo-bannerghatta",
                "is_demo": True,
                "ownership": "private",
                "address": "154/11 Bannerghatta Main Rd, Opp IIMB, Bengaluru",
                ...
                "rating": 4.8,
                "photos": [],
                "description": "JCI & NABH Accredited multi-specialty tertiary care center specializing in cardiac science, oncology, and robotic surgery.",
                "accessibility": ["wheelchair", "accessible parking", "tactile paths", "accessible elevators"],
            },
            I.HOSPITAL_MANIPAL: {
                "id": I.HOSPITAL_MANIPAL,
                "name": "Manipal Comprehensive Medical Center - Old Airport Rd",
                "slug": "manipal-old-airport-rd",
                "is_demo": True,
                "ownership": "private",
                ...
                "rating": 4.9,
                "photos": [],
                "description": "Premier quaternary healthcare institution with 24x7 trauma care, organ transplant center, and advanced clinical laboratory.",
                "accessibility": ["wheelchair", "accessible parking", "braille signage"],
            },
            I.HOSPITAL_FORTIS: {
                "id": I.HOSPITAL_FORTIS,
                "name": "Fortis Institute of Health Sciences - Cunningham Rd",
                "slug": "fortis-cunningham",
                "is_demo": True,
                "ownership": "private",
                ...
                "latitude": 12.9866,
                "longitude": 77.5962,
                "operating_hours": {"daily": "08:00–21:00", "emergency": "24x7"},
                "emergency_available": True,
                "open_now": True,
                "rating": 4.7,
                "photos": [],
                "description": "Excellence center for interventional cardiology, nephrology, minimally invasive surgery and preventive wellness.",
                "accessibility": ["wheelchair", "accessible restrooms", "valet parking"],
            },
            I.HOSPITAL_ASTER: {
                "id": I.HOSPITAL_ASTER,
                "name": "Aster CMI Hospital & Diagnostic Park",
                "slug": "aster-cmi-hebbal",
                "is_demo": True,
                "ownership": "private",
                "address": "43/2 New Airport Rd, NH 44, Sahakar Nagar, Bengaluru",
                ...
                "rating": 4.6,
                "photos": [],
                "description": "Modern multi-disciplinary hospital featuring pediatric ICU, advanced neuroscience unit, and 24x7 stroke management team.",
                "accessibility": ["wheelchair", "accessible parking", "wheelchair ramps"],
            },
        }
        ...
        for hid, names in [
            ...
            (I.HOSPITAL_APOLLO, [("Cardiology", "cardiology"), ("Oncology", "oncology"), ("Emergency", "emergency"), ("Robotic Surgery", "orthopedics"), ("Diagnostics", "diagnostics")]),
            (I.HOSPITAL_MANIPAL, [("Emergency 24x7", "emergency"), ("Cardiology", "cardiology"), ("Neurology", "neurology"), ("Pediatrics", "pediatrics"), ("Diagnostics", "diagnostics")]),
            (I.HOSPITAL_FORTIS, [("Cardiology", "cardiology"), ("Nephrology", "general"), ("Orthopedics", "orthopedics"), ("Emergency", "emergency"), ("Diagnostics", "diagnostics")]),
            (I.HOSPITAL_ASTER, [("Pediatrics & NICU", "pediatrics"), ("Neurology", "neurology"), ("Emergency", "emergency"), ("General Medicine", "general"), ("Diagnostics", "diagnostics")]),
        ]:
        ...
        names = [
            ...
            ("Dr. Vikram Venkatesh", "Cardiology", I.HOSPITAL_APOLLO),
            ("Dr. Sunita Deshmukh", "Robotic Surgery", I.HOSPITAL_APOLLO),
            ("Dr. Rajeshwar Hegde", "Emergency Medicine", I.HOSPITAL_MANIPAL),
            ("Dr. Pallavi Sengupta", "Neurology", I.HOSPITAL_MANIPAL),
            ("Dr. Sandeep Murthy", "Cardiology", I.HOSPITAL_FORTIS),
            ("Dr. Gayatri Nambiar", "Orthopedics", I.HOSPITAL_FORTIS),
            ("Dr. Ashwin Prabhu", "Pediatrics", I.HOSPITAL_ASTER),
            ("Dr. Radhika Kulkarni", "Neurology", I.HOSPITAL_ASTER),
        ]
